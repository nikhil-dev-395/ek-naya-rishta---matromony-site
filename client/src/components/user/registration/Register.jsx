        ...
        <>
            <section className="w-full py-10 bg-[#FFF7FC] pt-28">
                ...
                <main className="">
                    ...
                    <h1 className="text-xl text-center font-semibold">Rishta Register</h1>
                    ...
                    <form className="flex flex-col md:w-1/3 px-10  mx-auto py-5">
                        ...
                        <button type="submit" className="py-4 w-32 bg-black text-white hover:bg-[#8C94FF] hover:text-black px-3 border-2  border-black outline-none rounded-lg mt-4" onClick={registerProfile} >Register</button>
                    </form>
                    ...
                    <h2 className="text-center underline text-blue-500"><Link to="/register" >don`t have an account</Link></h2>
